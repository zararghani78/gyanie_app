...
class BioshopScreen extends StatefulWidget {
    final double height;
  final Function(bool)? onFavoriteChanged;
  const BioshopScreen({super.key, this.height = kToolbarHeight,
    this.onFavoriteChanged});
  @override
  State<BioshopScreen> createState() => _BioshopScreenState(); 
}
class _BioshopScreenState extends State<BioshopScreen> {
  ...
  children:  [
     Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("Bishop Score ",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),),
const SizedBox(height: 15,),
           const Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut laboreet dolore magna aliqua. Ut enim ad minim veniam, quis nostrud nulla pariatur.",style: TextStyle(color: Colors.black,fontSize: 12,),textAlign: TextAlign.justify,),
            ...
            Container(
              ...
              child:  Padding(
                ...
                child: Column(
                  crossAxisAlignment:CrossAxisAlignment.start,
                  children: [
                    Text("How To Calculate BISHOP?",style: TextStyle(color: Colors.black.withOpacity(0.7))),
                    Text("Bishop Score = Point1 + Point2 + Point3 + Point4 + Point5",style: TextStyle(color: Colors.black.withOpacity(0.7)),),
                 const SizedBox(height: 10,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                    const Text("Bishop Score: 0",style: TextStyle(color: Colors.black,fontSize: 17),),
                    Container(
                      width: 80,
                      alignment: Alignment.center,
                      height: 40,
...
const SizedBox(height: 20,),
              Container(
                      ...
                      child: const Text("Show Details",style: TextStyle(color: Colors.blue,fontSize: 18,fontWeight: FontWeight.bold),)  
                        ),                  
        ],
      ),
    ),
