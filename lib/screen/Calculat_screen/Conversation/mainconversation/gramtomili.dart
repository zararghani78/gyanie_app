...
class GRAMTOMILLI extends StatefulWidget {
    final double height;
  final Function(bool)? onFavoriteChanged;
  const GRAMTOMILLI({super.key, this.height = kToolbarHeight,
    this.onFavoriteChanged});
  @override
  State<GRAMTOMILLI> createState() => _GRAMTOMILLIState(); 
}
class _GRAMTOMILLIState extends State<GRAMTOMILLI> {
  ...
  children:  [
     Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("Grams To Milligrams",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),),
                ...
                child: Column(
                 ...
                 const SizedBox(height: 20,),
                  Row(
                    ...
                    children: [
                    Text("Grams",style: TextStyle(color: Colors.black.withOpacity(0.7),fontSize: 17),),
                   Container(
                    width: 60,
                    height: 20,
            ...
            Container(
              ...
              child:  Padding(
                ...
                child: Column(
                  crossAxisAlignment:CrossAxisAlignment.start,
                  children: [
                    Text("How To Calculate Gram to Milligram?",style: TextStyle(fontSize:12,color: Colors.black.withOpacity(0.7))),
                 ...
                 SizedBox(
                  width: 160,
                  child: const Text("Gram To Milligrams Conversion",style: TextStyle(fontWeight:FontWeight.bold,color: Colors.black,fontSize: 15),)),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
