...
import 'package:gyanie_app/screen/Calculat_screen/Endrometrics/endrotable.dart';

class ENDROMETRISCREEN extends StatefulWidget {
    final double height;
  final Function(bool)? onFavoriteChanged;
  const ENDROMETRISCREEN({super.key, this.height = kToolbarHeight,
    this.onFavoriteChanged});
  @override
  State<ENDROMETRISCREEN> createState() => _ENDROMETRISCREENState(); 
}
class _ENDROMETRISCREENState extends State<ENDROMETRISCREEN> {
