...
class IRONDEFICET extends StatefulWidget {
    final double height;
  final Function(bool)? onFavoriteChanged;
  const IRONDEFICET({super.key, this.height = kToolbarHeight,
    this.onFavoriteChanged});
  @override
  State<IRONDEFICET> createState() => _IRONDEFICETState(); 
}
class _IRONDEFICETState extends State<IRONDEFICET> {
  ...
  children:  [
     Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("Iron Deficit",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),),
                 ...
                 const SizedBox(height: 17,),
                  Row(
                   // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                    Text("Actual Body Weight",style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 15),),
                  ...
                  const SizedBox(height: 20,),
                   ...
                   // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                    Text("Actual Hb",style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 15),),
                  ...
                  //  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                    Text("Iron Stores",style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 15),),
