...
class FDASCREEN extends StatefulWidget {
  const FDASCREEN({super.key});

  @override
  State<FDASCREEN> createState() => _FDASCREENState();
}

class _FDASCREENState extends State<FDASCREEN> {
        ...
        child: ListView(
          children: [
            Column(
              ...
              children: [
                const Text("FDA Aproved Pregnancy Categories", style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold)),
              //  const SizedBox(height: 25),
               ...
               const SizedBox(height: 25,),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildDropdown(0, 'Category A', options1),
                    const SizedBox(height: 15,),
                    _buildDropdown(1, 'Category B', options2),

                                        const SizedBox(height: 15,),
                    _buildDropdown(2, 'Category C', options3),
                         const SizedBox(height: 15,),
                    _buildDropdown(3, 'Category D', options4),


                                        const SizedBox(height: 15,),
                    _buildDropdown(4, 'Category X', options5),
