...
class NUCHARTRANSSCREEN extends StatefulWidget {
  const NUCHARTRANSSCREEN({super.key});

  @override
  State<NUCHARTRANSSCREEN> createState() => _NUCHARTRANSSCREENState();
}

class _NUCHARTRANSSCREENState extends State<NUCHARTRANSSCREEN> {
  @override
...
body: Padding(padding: const EdgeInsets.only(top: 30,left: 30,right: 10,bottom: 10),
child: ListView(
  children:   [
...
Column(
  ...
  children: [
    const Text("Nuchal Translucency",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),),
...
Row( 
  crossAxisAlignment: CrossAxisAlignment.start,
    ...
    children: [
     ...
     // Add spacing between bullet and content
      Container(
        width: 10.0,
        height: 10.0,
        decoration: const BoxDecoration(
